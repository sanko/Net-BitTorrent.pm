...
- Blah blah blah, [CVE-2026-57081](https://github.com/sanko/Net-BitTorrent.pm/security/advisories/GHSA-mv44-v82p-89xv)
...
- Protect ourselves from OOM and other attacks by...
  - limiting MSE handshake buffer size
  ...
  - limiting the write buffer length for new pieces
  - limiting our piece hash checking queue
