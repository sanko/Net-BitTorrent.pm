...
Net::BitTorrent::Protocol::PeerHandler - Integrated Protocol Extension Orchestrator (v2.0.0)
...
C<Net::BitTorrent::Protocol::PeerHandler> is the "brain" of the Peer Wire Protocol implementation.  It utilizes
multiple inheritance (via the C<class> feature) to consolidate all supported  BitTorrent extensions into a single,
unified interface.
...
=head2 Supported Extensions (Managed by this Handler):
