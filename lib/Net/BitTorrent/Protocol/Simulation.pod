...
C<Net::BitTorrent::Protocol::Simulation> is a subclass of L<Net::BitTorrent::Protocol::BEP11> (which includes PEX and
Peer Exchange) designed for use in tests and simulations.
...
A L<Net::BitTorrent::Peer> object (or compatible mock) that should receive notifications of incoming messages.

=head1 METHODS

=head2 _handle_message ( $id, $payload )
