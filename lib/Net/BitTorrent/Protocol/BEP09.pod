...
=item * C<$piece_index>: The segment index being sent.

=item * C<$total_size>: The full length of the info dictionary.

=item * C<$data>: The raw binary bencoded data for this segment.
