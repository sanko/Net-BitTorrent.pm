...
Net::BitTorrent::Peer - Individual Peer Connection & State Tracking (v2.0.0)
...
This class implements B<Peer Reputation Tracking>.  * Peers start with a reputation of 100. * Providing a verified
piece increases reputation by 1. * Providing a corrupt piece (failed hash) decreases reputation by 20. * If reputation
falls to B<50 or below>, the peer is automatically disconnected and blacklisted for the session.
